...
datos_mza_gdl <- datos_mza %>% 
  filter(MUN=="039")


datos_ageb_gdl <- datos_mza_gdl %>% 
...
glimpse(datos_ageb_gdl)

datitos <- ageb_gdl %>% 
  left_join(datos_ageb_gdl)
...
gg +
  ...
  labs(x = NULL,
       y = NULL,
       title = "Grado promedio de escolaridad, GDL",
...
gg +
  ...
  labs(x = NULL,
       y = NULL,
       title = "Pon. sin afiliación a servicios de salud, GDL",
       subtitle = "Según AGEB. Censo de Población y Vivienda-2020",
       caption = "Fuente: Elaborado por Máximo E. Jaramillo Molina 
(@rojo_neon) con datos de CPV-2020.",
...
gg +
  ...
  labs(x = NULL,
       y = NULL,
       title = "Pob. afiliación a salud privada, GDL",
       subtitle = "Según AGEB. Censo de Población y Vivienda-2020",
       caption = "Fuente: Elaborado por Máximo E. Jaramillo Molina 
(@rojo_neon) con datos de CPV-2020.",
       fill = "Porcentaje de pob. 
...
gg +
  ...
  labs(x = NULL,
       y = NULL,
       title = "Promedio de ocupantes por habitación, GDL",
       subtitle = "Según AGEB. Censo de Población y Vivienda-2020",
       caption = "Fuente: Elaborado por Máximo E. Jaramillo Molina 
(@rojo_neon) con datos de CPV-2020.",
       fill = "Prom. ocupantes. 
...
gg +
  ...
  labs(x = NULL,
       y = NULL,
       title = "Porcentaje de viviendas con internet, GDL",
       subtitle = "Según AGEB. Censo de Población y Vivienda-2020",
       caption = "Fuente: Elaborado por Máximo E. Jaramillo Molina 
(@rojo_neon) con datos de CPV-2020.",
...
saveRDS(datitos_factor, file = "datitos_factor.rds")
...
gg +
  ...
  labs(x = NULL,
       y = NULL,
       title = "Índice de estratificación social, GDL",
       subtitle = "Según AGEB. Censo de Población y Vivienda-2020",
...
datitos_factor_mza <- cbind(datitos_mza,factor_gdl)
...
saveRDS(datitos_factor_mza, file = "datitos_factor_mza.rds")
